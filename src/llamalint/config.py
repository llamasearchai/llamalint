...
class Config:
    ...
    def __init__(
        ...
        """
        self.include = include or ["**/*.py", "**/*.js", "**/*.ts", "**/*.jsx", "**/*.tsx"]
        self.exclude = exclude or ["**/node_modules/**", "**/.venv/**", "**/__pycache__/**", "**/dist/**", "**/build/**"]
                    ...
                    try:
                        if name == "pyproject.toml":
                            with open(config_path, "r") as f:
                                ...
                                if "tool" in pyproject_data and "llamalint" in pyproject_data["tool"]:
                                    return cls.from_dict(pyproject_data["tool"]["llamalint"])
