...
class Rule(ABC):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self._file_pattern_regexes = [
            self._glob_to_regex(pattern) for pattern in self.file_patterns
        ]
    ...
    def applies_to_file(self, file_path: Union[str, Path]) -> bool:
        ...
        return any(
            pattern.search(file_path_str) for pattern in self._file_pattern_regexes
        )
