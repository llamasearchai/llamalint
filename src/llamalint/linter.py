...
class LlamaLint:
    ...
    def lint_file(self, file_path: Union[str, Path], fix: bool = False) -> List[RuleResult]:
        """
        Lint a single file
    ...
    def lint_directory(self, directory: Union[str, Path], fix: bool = False) -> List[RuleResult]:
        """
    ...
    def _apply_fixes(self, file_path: Path, content: str, results: List[RuleResult]) -> str:
        """
